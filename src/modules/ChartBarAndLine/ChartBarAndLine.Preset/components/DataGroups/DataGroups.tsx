import { EditOutlined, MinusOutlined, PlusOutlined, SettingOutlined } from '@ant-design/icons';
import { PageHeader, Row, Col, Tooltip, Button, Divider, List, Form } from 'antd';
    ...
    <>
      ...
      <Row>
        ...
        <Col span={23}>
          <Card size="small"
            bodyStyle={{padding: 0}}
            title={<div className={s.title}><MoveIcon />数据组<Button size="small" type="text" icon={<EditOutlined />} /></div>}
            extra={<>
              <Button size="small" type="text">
                <SettingOutlined />
              </Button>&nbsp;
              <Button size="small" type="text"><MinusOutlined /></Button>
            </>}
          >
            <ChartConfig />
          </Card>
