...
import ShadowListHoc from "~/components/MiniDashboard/Shadow/ShadowListHoc";
...
const Shadow: React.FC<Props> = () => {
  ...
  // init DefaultData
  useEffect(() => {
    let textShadowList: TextShadow[] = context.style?.textShadow || [];
    let boxShadowList: BoxShadow[] = context.style?.boxShadow || [];
